 /*
		 ...
		 * Date : 10/1/2024
		 * Content : Functions Prototypes
		 *
		 *
 */

#ifndef INC_BOOTLADER_H_
#define INC_BOOTLADER_H_
...
#define CBL_GET_VERSION_CMD				0x10
...
#define CRC_VERFING_FAILED			0x00
#define CRC_VERFING_PASSED			0x01
